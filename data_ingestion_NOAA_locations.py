...
class DataIngestion:
    ...
    def parse_method(self, string_input):
        ...
        values = re.split(",",
                          re.sub('\r\n', '', re.sub('"', '', string_input)))
        row = dict(
            zip(('YEARMONTH', 'EPISODE_ID', 'EVENT_ID', 'LOCATION_INDEX', 'RANGE', 'AZIMUTH','LOCATION','LATITUDE','LONGTITUDE','LAT2','LON2'),
                values))
        return row
...
def run(argv=None):
    ...
    parser.add_argument(
        ...
        default='gs://nimble-octagon-306023/NOAA/Locations/*')
    ...
    (p
     ...
     | 'Write to BigQuery' >> beam.io.Write(
         beam.io.BigQuerySink(
             ...
             # fieldName:fieldType
             schema='YEARMONTH:STRING,EPISODE_ID:STRING,EVENT_ID:STRING,LOCATION_INDEX:STRING,'
             'RANGE:STRING,AZIMUTH:STRING,LOCATION:STRING,LATITUDE:STRING,LONGTITUDE:STRING,LAT2:STRING,LON2:STRING',
